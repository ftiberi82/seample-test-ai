...
/**
 * Base astratta per le entità con campi di auditing e periodi di validità temporale.
 * I campi sono marcati insertable/updatable = false dove vengono popolati da default/triggers lato DB.
 */
@Getter
@Setter
@MappedSuperclass
